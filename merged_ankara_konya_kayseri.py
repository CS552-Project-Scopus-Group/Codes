...
data_directory = r"C:\Users\emre.ozturk\Desktop\SCRAP\All_universities_2"
output_file = r"C:\Users\emre.ozturk\Desktop\SCRAP\merged_data_emre.xlsx"
...
def find_and_merge_excels(base_path, output_path):
    ...
    for root, dirs, files in os.walk(base_path):
        for file in files:
            # Check for excel files named exactly "güncellenmiş_dosya" or ending with "academic_staff"
            if file == "güncellenmiş_dosya.xlsx" or file.endswith("academic_staff.xlsx"):
